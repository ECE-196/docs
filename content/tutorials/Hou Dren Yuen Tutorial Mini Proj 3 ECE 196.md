...
![relevant graphic or workshop logo](MiniProj3-Hou-Dren-Yuen/OLED.jpg)

## Introduction

Write a short section on what the tutorial is aiming to accomplish.

This tutorial aims to teach students how to display text on an OLED using an ESP 32 microcontroller.
...
- Download the Adafruit SSD1306 libraries
